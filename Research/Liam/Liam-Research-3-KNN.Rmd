...
```{r}
#TODO 
pairwise_preprocess = function(GSE, top_x, transform_type) {
  exp_GSE = (exprs(GSE))
...
pairwise = function(exp_GSE, intersection) {
...
z1 = pairwise_preprocess(gse36059, 2000, "Pair")
z2 = pairwise_preprocess(gse48581, 2000, "Pair")

intersection = intersect(row_names(z1), row_names(z2))
