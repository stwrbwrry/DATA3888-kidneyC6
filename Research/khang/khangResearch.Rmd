...
# which(unique(userFile[,1])=="outcomes") 


userFile[,1]
length(colnames(userFile))
dim(userFile[-which(userFile[[1]] == 'diagnosis'),])
userBinaryOutcomes <- tail(unname(unlist(userFile[which(userFile[[1]] == 'diagnosis'), ])),-1)
