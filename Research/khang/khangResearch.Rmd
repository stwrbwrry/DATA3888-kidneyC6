...
# write_csv(output,"/Users/khangnguyen/Documents/DATA3888/DATA3888-kidneyC6/Research/Liam/Data/userUploadData.csv")
...
userExpression <- as.matrix(as.data.frame(t(as.matrix(userFile[-diagnosisIndex,])))) 
userBinaryOutcomes <-  as.factor(unname(unlist(userFile[diagnosisIndex, ])))

# dim(userExpression)
# length(userBinaryOutcomes)
ncol(userExpression)
ncol(userFile[diagnosisIndex, ])
ncol()
